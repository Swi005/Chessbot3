...
public class Move implements Comparable, Serializable
{
    ...
    private Chessbot3.MiscResources.Tuple<Integer, Integer> from;
    private Chessbot3.MiscResources.Tuple<Integer, Integer> to;
    private boolean stabilityIndex;
    private int weight;
    private String chars = "ABCDEFGH";
    private String chars2 = chars.toLowerCase();
    public Move(Chessbot3.MiscResources.Tuple<Integer, Integer> from , Chessbot3.MiscResources.Tuple<Integer, Integer> to)
    {
        this.from = from;
        this.to = to;
        this.weight = 0;
    ...
    public Move(Chessbot3.MiscResources.Tuple<Integer, Integer> from , Chessbot3.MiscResources.Tuple<Integer, Integer> to, boolean stabIndex, int weight)
    {
        this.from = from;
        this.to = to;
    ...
    public Chessbot3.MiscResources.Tuple<Integer, Integer> getX() { return this.from; }
    public Chessbot3.MiscResources.Tuple<Integer, Integer> getY() { return this.to; }
    public int getWeight() {return this.weight; }
    public boolean getStabIndex() { return this.stabilityIndex; }

    public void setX(Chessbot3.MiscResources.Tuple<Integer, Integer> from) { this.from = from; }

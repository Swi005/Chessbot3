...
public class Gui {
    ...
    //Om tekstfeltet har en feilmelding i seg akkurat nå.
    ...
    //protected static JButton stopp = new JButton("Stop bot");
    ...
    private JPanel initializeGUI() {
        ...
        toolbar2.add(back);
        //toolbar2.add(stopp);
        //stopp.addActionListener(new Action());
